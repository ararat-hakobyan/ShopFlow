        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Couriers_Users_CourierID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourierCoordinates = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProofOfDeliveryUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketItems_ProductVariants_VariantID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_BasketID_VariantID",
                table: "BasketItems",
                columns: new[] { "BasketID", "VariantID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_VariantID",
                table: "BasketItems",
                column: "VariantID");
